...
export const PixelButton: React.FC<PixelButtonProps> = ({
  ...
  return (
    <div className={`inline-block ${currentVariant.dropShadow} transition-transform duration-100 active:scale-95`}>
      <button
        disabled={disabled}
        className={`
          relative
      ...
      >
        ...
        <span className={`absolute inset-0 border-2 ${currentVariant.borderColor} pixel-corners-3step pointer-events-none`} />
